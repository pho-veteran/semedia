...
class VideoScene(Base):
    ...
    embedding: Mapped[list[float] | None] = mapped_column(EmbeddingType, nullable=True)
    retrieval_text: Mapped[str] = mapped_column(Text, default="")
    keyframe_paths: Mapped[list[str] | None] = mapped_column(EmbeddingType, nullable=True)
    thumbnail_paths: Mapped[list[str] | None] = mapped_column(EmbeddingType, nullable=True)
    captions: Mapped[list[str] | None] = mapped_column(EmbeddingType, nullable=True)
    embeddings: Mapped[list[list[float]] | None] = mapped_column(EmbeddingType, nullable=True)
